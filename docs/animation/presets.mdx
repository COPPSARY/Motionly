---
title: Animation and transition presets
description: Reference for Motionly's editor and language presets, including fade, rise, scale, blur, drift, count up, drawSVG, and scene transitions.
---
