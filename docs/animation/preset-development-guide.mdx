---
title: Animation preset development guide
description: Standards for building Motionly animation presets, covering research, parameter design, defaults, implementation, visual testing, and iteration.
---
