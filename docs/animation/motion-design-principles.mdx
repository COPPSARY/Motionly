---
title: Motion design research and principles
description: Research notes on timing, easing, staging, and polish from Apple, Linear, Framer, and GSAP that inform Motionly's animation preset library.
---
