...
description: How Motionly parses .motion files into a deterministic scene graph that normalizes canvas, imports, elements, camera, layers, and animation presets.
---
