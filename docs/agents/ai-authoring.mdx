...
- `references/skills/*/SKILL.md` — the full library: `motion-dsl`, `motion-system`, `components`, `svg`, `animation`, `easing`, `camera`, `composition`, `typography`, `transitions`, `timeline`, `assets`, `rendering`, and `templates`.
