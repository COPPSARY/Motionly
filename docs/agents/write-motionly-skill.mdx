...
Before editing, an agent identifies the project type, output path, canvas/FPS/duration, audience, exact copy, narration timing, brand constraints, required assets, and prohibited treatments. It should preserve unrelated user work and avoid guessing media dimensions or duration.
