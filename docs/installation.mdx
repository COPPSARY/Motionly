---
title: Install Motionly with Node.js and FFmpeg
description: Install Motionly locally with Node.js and FFmpeg, run the desktop editor, verify the setup, and troubleshoot common install and dependency issues.
---
...
After setup Motionly starts the project and prints `http://localhost:4173`. Press `Ctrl+C` to stop it, then reopen later with:
