...
/** Published component names mapped to the nearest editable Motionly recipe. */
...
const definitions = {
  ...
  ...Object.fromEntries(
    Object.entries(REACTBITS_COMPONENT_ALIASES).map(([alias, target]) => [
      alias,
      {
        ...
        type: alias,
        icon: alias,
        source: `Motionly native ${alias} structured component`,
        license: 'Motionly',
      },
    ])
  ),
  ...
  sidebar: {
    ...
    type: 'sidebar',
    source: 'Motionly native sidebar component',
    license: 'Motionly',
    width: 280,
    height: 434,
    defaultBehavior: 'navigationReveal',
    layers: ['surface', 'brand', 'item0', 'label0', 'item1', 'label1', 'item2', 'label2'],
  },
  table: {
    ...baseDefinitions.dashboard,
    type: 'table',
    source: 'Motionly native table component',
    license: 'Motionly',
    width: 860,
    height: 500,
    defaultBehavior: 'rowCascade',
    layers: ['panel', 'title', 'row0', 'rowLabel0', 'rowAction0', 'row1', 'rowLabel1'],
  },
  'command-palette': {
    ...baseDefinitions.modal,
    type: 'command-palette',
    source: 'Motionly native command palette component',
    license: 'Motionly',
    width: 620,
    height: 422,
    defaultBehavior: 'rowCascade',
    layers: ['panel', 'title', 'search', 'query', 'row0', 'rowLabel0', 'rowAction0'],
  },
  'search-bar': {
    ...baseDefinitions.form,
    type: 'search-bar',
    source: 'Motionly native search bar component',
    license: 'Motionly',
    width: 560,
    height: 72,
    defaultBehavior: 'controlReveal',
    layers: ['surface', 'marker', 'label', 'shortcut'],
  },
  avatar: {
    ...baseDefinitions.logo,
    type: 'avatar',
    source: 'Motionly native avatar component',
    license: 'Motionly',
    width: 120,
    height: 120,
    defaultBehavior: 'identityReveal',
    layers: ['halo', 'face', 'initials'],
  },
  badge: {
    ...baseDefinitions.card,
    type: 'badge',
    source: 'Motionly native badge component',
    license: 'Motionly',
    width: 180,
    height: 54,
    defaultBehavior: 'controlReveal',
    layers: ['surface', 'marker', 'label'],
  },
  tag: {
    ...baseDefinitions.card,
    type: 'tag',
    source: 'Motionly native tag component',
    license: 'Motionly',
    width: 200,
    height: 60,
    defaultBehavior: 'controlReveal',
  ...
  timeline: {
    ...baseDefinitions.navigation,
    type: 'timeline',
    source: 'Motionly native timeline component',
    license: 'Motionly',
    width: 720,
    height: 166,
    defaultBehavior: 'stepCascade',
    layers: ['surface', 'line', 'step0', 'label0', 'step1', 'label1', 'step2', 'label2'],
  },
  stepper: {
    ...baseDefinitions.navigation,
    type: 'stepper',
    source: 'Motionly native stepper component',
    license: 'Motionly',
    width: 720,
    height: 166,
    defaultBehavior: 'stepCascade',
  ...
  footer: {
    ...baseDefinitions.navigation,
    type: 'footer',
    source: 'Motionly native footer component',
    license: 'Motionly',
    width: 920,
    height: 276,
    defaultBehavior: 'contentCascade',
    layers: ['surface', 'brand', 'column0', 'column1', 'column2', 'legal'],
  },
  'logo-grid': {
    ...baseDefinitions.logo,
    type: 'logo-grid',
    source: 'Motionly native logo grid component',
    license: 'Motionly',
    width: 760,
    height: 320,
    defaultBehavior: 'gridCascade',
    layers: ['title', 'tile0', 'logo0', 'tile1', 'logo1', 'tile2', 'logo2'],
  },
  testimonials: {
    ...baseDefinitions.card,
    type: 'testimonials',
    source: 'Motionly native testimonial component',
    license: 'Motionly',
    width: 560,
    height: 358,
    defaultBehavior: 'contentCascade',
    layers: ['surface', 'quote', 'avatar', 'author', 'role'],
  },
  'faq-accordion': {
    ...baseDefinitions.card,
    type: 'faq-accordion',
    source: 'Motionly native FAQ accordion component',
    license: 'Motionly',
    width: 680,
    height: 422,
    defaultBehavior: 'rowCascade',
  ...
  ...Object.fromEntries(
    Object.entries(REACTBITS_COMPONENT_ALIASES).map(([alias, target]) => {
      ...
      return [
        ...
        {
          ...base,
          purpose: `Motionly ${alias} pattern. ${base.purpose}`,
